...
(function (window) {
	...
	MLSlideshow.prototype._navigate = function (direction) {
		...
		var animateIn = function () {
			...
			var inItems = [].slice.call(nextSlide.querySelectorAll('.slide-imgwrap .slide_img-inner')),
		...
		var outItems = [].slice.call(currentSlide.querySelectorAll('.slide-imgwrap .slide_img-inner')),
